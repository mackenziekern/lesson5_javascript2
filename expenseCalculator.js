        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               if (income <= 18550){
                 ...
                 taxRate = 33;
                  ...
                  tax = 18550 * 0.10 + (75300 - 18500) * 0.15 +
                        (151900 - 75300) * 0.25 + (231450 - 151900) * 0.28 +
                        (466950 - 231450) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 18550 * 0.10 + (75300 - 18550) * 0.15 +
          ...
          }//end of married file jontly calculation
          ...
          *******************************************************************************/
            ...
            // Compute tax for married seperate filers
               if (income <= 9275){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
                 ...
                 tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                       (91150 - 37650) * 0.25 + (income - 75950) * 0.28;
                 taxRate = 28;
               }//end of else if
                 ...
                 taxRate = 33;
                  ...
                  tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                        (75950 - 37650) * 0.25 + (115725 - 75950) * 0.28 +
                        (206675 - 115725) * 0.33 + (233475 - 206675 ) * 0.35 + (income - 415050) * .396;
                  taxRate = 39.6;
               }//end of nested if
